...
declare class Neode{
     ...
     * @returns {Transaction}
     */
    getTxcTransaction():Transaction

    /**
     * get session
     * @returns {Session}
     */
    getSessionTransaction():Session
     ...
     * @return {Promise<void>}
     */
    closeBeginTransaction():Promise<void>
...
declare namespace Neode{
    ...
    class Builder{
         ...
         */
        match<T>(alias:string, model:Model<T>|string):Builder;

        optionalMatch<T>(alias:string, model:Model<T>|string):Builder;
         ...
         * @return {Builder}
         */
        to<T>(alias:string, model:Model<T>|string):Builder;
